...
public sealed class WorldService(ILogger<WorldService> logger) : IHostedService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        // foreach (var e in _world.Query<Position, Velocity>()
        //              .WithTag<DogTag>())
        // {
        ...
        //         logger.LogInformation($"{entity}: {tag.GetNameAsSpan()} | {pos}, {vel}");
        // }
