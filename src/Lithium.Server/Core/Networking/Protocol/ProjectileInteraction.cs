...
public class ProjectileInteraction : SimpleInteraction
{
    public override int TypeId => 32;
    
    [JsonPropertyName("configId")] public string? ConfigId { get; set; }
    ...
    public override void Serialize(PacketWriter writer)
    {
        ...
        if (ConfigId is not null) bits.SetBit(32);
        ...
        var configIdOffsetSlot = writer.ReserveOffset();
        ...
        {
            writer.WriteOffsetAt(configIdOffsetSlot, writer.Position - varBlockStart);
            writer.WriteVarUtf8String(ConfigId, 4096000);
        }
        else writer.WriteOffsetAt(configIdOffsetSlot, -1);
    }
    ...
    public override void Deserialize(PacketReader reader)
    {
        ...
        if (bits.IsSet(32)) ConfigId = reader.ReadVarUtf8StringAt(offsets[5]);
    }
