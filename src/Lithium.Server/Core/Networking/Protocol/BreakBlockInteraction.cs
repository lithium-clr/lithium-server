...
public class BreakBlockInteraction : SimpleBlockInteraction
{
    public override int TypeId => 3;
    
    [JsonPropertyName("harvest")] public bool Harvest { get; set; }
    ...
    public override int ComputeSize() => 41;
}