...
public class SimpleBlockInteraction : SimpleInteraction

{
    public override int TypeId => 0;

    [JsonPropertyName("useLatestTarget")] public bool UseLatestTarget { get; set; }
    ...
    public override int ComputeSize() => 40;
}