...
public sealed record PacketResult(int PacketId, string? PacketName, INetworkSerializable? Packet, Exception? Exception)
{
    ...
    public static PacketResult Ok(int packetId, string packetName, INetworkSerializable packet)
    {
