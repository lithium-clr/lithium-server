...
public class PlaceBlockInteraction : SimpleInteraction
{
    public override int TypeId => 2;
    
    [JsonPropertyName("blockId")] public int BlockId { get; set; }
    [JsonPropertyName("removeItemInHand")] public bool RemoveItemInHand { get; set; }

    [JsonPropertyName("allowDragPlacement")]
    public bool AllowDragPlacement { get; set; }
    ...
    public override void Serialize(PacketWriter writer)
    {
        ...
        writer.WriteBoolean(RemoveItemInHand);
        writer.WriteBoolean(AllowDragPlacement);
    ...
    public override void Deserialize(PacketReader reader)
    {
        ...
        RemoveItemInHand = reader.ReadBoolean();
        AllowDragPlacement = reader.ReadBoolean();
