...
public class ChangeStatInteraction : SimpleInteraction
{
    ...
    [JsonPropertyName("valueType")] public ValueType ValueType { get; set; } = ValueType.Percent;
    [JsonPropertyName("statModifiers")] public Dictionary<int, float>? StatModifiers { get; set; }

    [JsonPropertyName("changeStatBehaviour")]
    public ChangeStatBehaviour ChangeStatBehaviour { get; set; } = ChangeStatBehaviour.Add;
    ...
    public override void Serialize(PacketWriter writer)
    {
        ...
        writer.WriteEnum(ChangeStatBehaviour);
        ...
        {
            writer.WriteOffsetAt(statModifiersOffsetSlot, writer.Position - varBlockStart);
        ...
        else writer.WriteOffsetAt(statModifiersOffsetSlot, -1);
    }
    ...
    public override void Deserialize(PacketReader reader)
    {
        ...
        ChangeStatBehaviour = reader.ReadEnum<ChangeStatBehaviour>();
        ...
        if (bits.IsSet(32))
            StatModifiers = reader.ReadDictionaryAt(offsets[5], r => r.ReadInt32(), r => r.ReadFloat32());
    }
