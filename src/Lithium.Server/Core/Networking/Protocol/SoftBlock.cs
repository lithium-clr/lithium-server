...
public sealed class SoftBlock : INetworkSerializable
{
    [JsonPropertyName("itemId")] public string? ItemId { get; set; }
    [JsonPropertyName("dropListId")] public string? DropListId { get; set; }

    [JsonPropertyName("isWeaponBreakable")]
    public bool IsWeaponBreakable { get; set; }
    ...
    public void Serialize(PacketWriter writer)
    {
        ...
        writer.WriteBoolean(IsWeaponBreakable);
    ...
    public void Deserialize(PacketReader reader)
    {
        ...
        IsWeaponBreakable = reader.ReadBoolean();
