...
public class MovementConditionInteraction : SimpleInteraction
{
    public override int TypeId => 31;
    
    [JsonPropertyName("forward")] public int Forward { get; set; }
    [JsonPropertyName("back")] public int Back { get; set; }
    [JsonPropertyName("left")] public int Left { get; set; }
    [JsonPropertyName("right")] public int Right { get; set; }
    [JsonPropertyName("forwardLeft")] public int ForwardLeft { get; set; }
    [JsonPropertyName("forwardRight")] public int ForwardRight { get; set; }
    [JsonPropertyName("backLeft")] public int BackLeft { get; set; }
    [JsonPropertyName("backRight")] public int BackRight { get; set; }
    ...
    public override void Serialize(PacketWriter writer)
    {
        ...
        writer.WriteInt32(Forward);
        writer.WriteInt32(Back);
        writer.WriteInt32(Left);
        writer.WriteInt32(Right);
        writer.WriteInt32(ForwardLeft);
        writer.WriteInt32(ForwardRight);
        writer.WriteInt32(BackLeft);
        writer.WriteInt32(BackRight);
    ...
    public override void Deserialize(PacketReader reader)
    {
        ...
        Forward = reader.ReadInt32();
        Back = reader.ReadInt32();
        Left = reader.ReadInt32();
        Right = reader.ReadInt32();
        ForwardLeft = reader.ReadInt32();
        ForwardRight = reader.ReadInt32();
        BackLeft = reader.ReadInt32();
        BackRight = reader.ReadInt32();
    ...
    public override int ComputeSize() => 71;
}