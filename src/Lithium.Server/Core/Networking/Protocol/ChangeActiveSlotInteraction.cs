...
public class ChangeActiveSlotInteraction : Interaction
{
    public override int TypeId => 24;
    
    [JsonPropertyName("targetSlot")] public int TargetSlot { get; set; } = int.MinValue;
