...
public class ChangeStateInteraction : SimpleBlockInteraction
{
    public override int TypeId => 17;
    
    [JsonPropertyName("stateChanges")] public Dictionary<string, string>? StateChanges { get; set; }
    ...
    public override void Serialize(PacketWriter writer)
    {
        ...
        if (StateChanges is not null) bits.SetBit(32);
        ...
        var stateChangesOffsetSlot = writer.ReserveOffset();
        ...
        {
            writer.WriteOffsetAt(stateChangesOffsetSlot, writer.Position - varBlockStart);
            writer.WriteVarInt(StateChanges.Count);
        ...
        else writer.WriteOffsetAt(stateChangesOffsetSlot, -1);
    }
    ...
    public override void Deserialize(PacketReader reader)
    {
        ...
        if (bits.IsSet(32))
            StateChanges = reader.ReadDictionaryAt(offsets[5], r => r.ReadUtf8String(), r => r.ReadUtf8String());
    }
