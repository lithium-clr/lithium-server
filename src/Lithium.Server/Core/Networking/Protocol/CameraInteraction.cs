...
public class CameraInteraction : SimpleInteraction
{
    public override int TypeId => 41;

    [JsonPropertyName("cameraAction")]
    public CameraActionType CameraAction { get; set; } = CameraActionType.ForcePerspective;

    [JsonPropertyName("cameraPerspective")]
    public CameraPerspectiveType CameraPerspective { get; set; } = CameraPerspectiveType.First;

    [JsonPropertyName("cameraPersist")] public bool CameraPersist { get; set; }

    [JsonPropertyName("cameraInteractionTime")]
    public float CameraInteractionTime { get; set; }
    ...
    public override void Serialize(PacketWriter writer)
    {
        ...
        writer.WriteEnum(CameraAction);
        writer.WriteEnum(CameraPerspective);
        writer.WriteBoolean(CameraPersist);
        writer.WriteFloat32(CameraInteractionTime);
    ...
    public override void Deserialize(PacketReader reader)
    {
        ...
        CameraAction = reader.ReadEnum<CameraActionType>();
        CameraPerspective = reader.ReadEnum<CameraPerspectiveType>();
        CameraPersist = reader.ReadBoolean();
        CameraInteractionTime = reader.ReadFloat32();
